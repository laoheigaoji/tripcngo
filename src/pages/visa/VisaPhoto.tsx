...
export default function VisaPhoto() {
  ...
  return (
    <VisaLayout breadcrumbTitle="照片要求">
      <h2 className="text-2xl font-bold text-center mb-10 text-gray-900">中国签证照片要求</h2>
      
      <div className="flex flex-col lg:flex-row gap-10 mb-12">
        {/* Left Column: Text */}
        <div className="flex-1 space-y-6">
          <section>
            <h3 className="text-lg font-bold text-[#1b887a] mb-2">通用要求</h3>
          ...
          <section>
            <h3 className="text-lg font-bold text-[#1b887a] mb-2">照片尺寸</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            <h3 className="text-lg font-bold text-[#1b887a] mb-2">面部要求</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            <h3 className="text-lg font-bold text-[#1b887a] mb-2">头饰要求</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            <h3 className="text-lg font-bold text-[#1b887a] mb-2">数字照片要求</h3>
            ...
            <p className="text-sm text-red-500">
              注意：如果您以电子方式提交签证照片，请携带两张打印照片参加面试。
            </p>
          </section>
        </div>
        ...
        <div className="w-full lg:w-[350px] flex flex-col items-center">
          <div className="bg-[#a8c6fa] p-6 rounded-md mb-2 flex flex-col items-center justify-center w-full relative">
            <div className="relative border border-blue-400 bg-white inline-block">
               ...
               <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-gray-600 w-max">15-22mm</div>
               <div className="absolute border-t border-blue-500 w-[15px] -top-2 left-1/2 -translate-x-1/2"></div>
               
               <div className="absolute top-1/2 -left-8 -translate-y-1/2 text-[10px] text-gray-600">28-33mm</div>
               <div className="absolute border-l border-blue-500 h-[28px] top-1/2 -left-2 -translate-y-1/2"></div>
               
               <img src={baseImage} alt="尺寸图示" className="w-[120px] h-[160px] object-cover object-top" />
            </div>
          </div>
          <p className="text-xs text-gray-500 mb-6 text-center">照片尺寸: 33mm (宽) × 48mm (高)</p>

          <div className="w-full">
            <h4 className="text-sm font-bold text-gray-900 mb-3">合格照片示例</h4>
            <img src={childImage} alt="合格照片示例" className="rounded-sm" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50/50 border border-gray-100 rounded-sm p-6">
        ...
        <div className="flex flex-col items-center">
            ...
            <span className="text-[14px] font-bold text-gray-700 text-center px-1">不合格照片示例</span>
        </div>
      </div>
